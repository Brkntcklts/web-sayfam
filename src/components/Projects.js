...
const Projects = () => {
  ...
  const additionalProject = {
    ...
    image: "",
    text: {
      en: "A pizza ordering website challenge completed as part of a full-stack development course.",
      tr: "Tam yığın geliştirme kursunun bir parçası olarak tamamlanan bir pizza sipariş web sitesi meydan okuması."
    },
    skills: ["React", "JavaScript", "CSS", ],
    website: "",
    git: "https://github.com/Brkntcklts/fsweb-s7-challenge-pizza"
  }

  const projectsData = [...myData.projects, additionalProject]

  const projects = projectsData.map((e, idx) => {
